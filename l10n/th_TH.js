OC.L10N.register(
    ...
    "Download" : "ดาวน์โหลด",
    "Close" : "ปิด",
    "Ajax cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." : "ตรวจพบ Ajax cron mode! ฟีดของคุณจะไม่ได้รับการอัพเดทอย่างถูกต้อง แนะนำให้ใช้ทั้งระบบปฏิบัติการ cron หรืออัพเดทที่กำหนดเอง",
    ...
    "Rename" : "เปลี่ยนชื่อ",
    "Menu" : "เมนู",
    "No feed ordering" : "ไม่มีฟีดที่สั่งซื้อ",
    "Reversed feed ordering" : "ย้อนกลับการสั่งซื้อฟีด",
    "Normal feed ordering" : "การสั่งซื้อฟีดปกติ",
    ...
    "Reverse ordering (oldest on top)" : "ย้อนกลับการสั่งซื้อ (เก่าที่ที่สุดอยู่ด้านบน)",
