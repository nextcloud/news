OC.L10N.register(
    ...
    "Defines the maximum amount of articles that can be read per feed which won't be deleted by the cleanup job; if old articles reappear after being read, increase this value; negative values such as -1 will turn this feature off" : "Ορίζει τη μέγιστη ποσότητα άρθρων που μπορούν να διαβαστούν ανά ροή, τα οποία δεν θα διαγραφούν από την εργασία καθαρισμού; εάν τα παλαιά άρθρα επανεμφανιστούν μετά την ανάγνωσή τους, αυξήστε αυτήν την τιμή; οι αρνητικές τιμές, όπως το -1, θα απενεργοποιήσουν αυτή τη λειτουργία",
