OC.L10N.register(
    ...
    "Detected feed format is not supported" : "Påvist nyhetskildeformat støttes ikke",
    ...
    "Forbidden to access feed" : "Tilgang til nyhetskilden forbys",
    ...
    "Defines the maximum amount of articles that can be read per feed which won't be deleted by the cleanup job; if old articles reappear after being read, increase this value; negative values such as -1 will turn this feature off" : "Definerer maksimalt antall artikler som kan leses pr. nyhetskilde som ikke vil bli slettet av opprenskningsjobben. Hvis gamle artikler dukker opp igjen etter at de er lest, øk denne verdien. Negative verdier, som -1, vil slå av denne funksjonen",
    ...
    "Maximum feed page size" : "Maksimal størrelse på nyhetskildeside",
    "Maximum feed size in bytes. If the RSS/Atom page is bigger than this value, the update will be aborted" : "Maksimal nyhetskildestørrelse i byte. Hvis RSS/Atom-siden er større enn dette, avbrytes oppdateringen",
    ...
    "Mark current article's feed/folder read" : "Merk denne artikkelens nyhetskilde/mappe som lest",
    "Ajax or webcron mode detected! Your feeds will not be updated!" : "Ajax eller vev- Cron-metode påvist! Nyhetskildene dine vil ikke bli oppdaterte!",
    ...
    "Feed exists already!" : "Nyhetskilden finnes allerede!",
    "Folder" : "Mappe",
    ...
    "Error when importing: OPML is does neither contain feeds nor folders" : "Feil ved import: OPML inneholder hverken nyhetskilder eller mapper",
