...
"Request failed, network connection " => "Požadavek selhal, síťové připojení",
...
"Token expired or app not enabled! " => "Token vypršel nebo není aplikace povolena!",
...
"Token expired or app not enabled! Try to reload the page!" => "Token vypršel nebo aplikace není povolena! Zkuste obnovit stránku!",
...
"Rename" => "Přejmenovat",
"Menu" => "Menu",
"No feed ordering" => "Bez zdroje dat",
"Reversed feed ordering" => "Opačné čtení dat",
"Normal feed ordering" => "Normální čtení dat",
