OC.L10N.register(
    ...
    "Certificate error: A problem occurred somewhere in the SSL/TLS handshake. Could be certificates (file formats, paths, permissions), passwords, and others." : "Certificaat fout: Er bevind zicht een probleem ergens in de SSL/TLS handshake. Fout kan zitten in certificaten (bestand formats, paden, permissies), wachtwoorden en andere.",
    "Certificate error: The remote server's SSL certificate or SSH md5 fingerprint was deemed not OK." : "Certificaat fout: De remote server's SSL certificaat of SSH md5 fingerprint was geacht niet OK.",
    "Certificate error: Problem with the local client certificate." : "Certificaat fout: Probleem met de lokale cliënt certificaat.",
    "Certificate error: Couldn't use specified cipher." : "Certificaat fout: Onbevoegde cijfer gespecificeerd.",
    ...
    "Certificate error: Requested FTP SSL level failed." : "Certificaat fout: Aangevraagde FTP SSL level mislukt.",
    "Certificate error: Initiating the SSL engine failed." : "Certificaat fout: Initialisatie van de SSL Engine mislukte.",
    "Certificate error: Problem with reading the SSL CA cert (path? access rights?)" : "Certificaat fout: Probleem met het uitlezen van de SSL CA cert (pad? toegang permissies?)",
    "Certificate error: Issuer check failed" : "Certificaat fout:  Verificatie van uitgever mislukt",
