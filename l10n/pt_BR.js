OC.L10N.register(
    ...
    "Can not add feed: Unable to parse feed" : "Não é possível adicionar feed: Não é possível analisá-lo",
    ...
    "Defines the maximum amount of articles that can be read per feed which won't be deleted by the cleanup job; if old articles reappear after being read, increase this value; negative values such as -1 will turn this feature off" : "Define a quantidade máxima de artigos que pode ser lido pelo feed e qual não será excluída pela tarefa de limpeza; se artigos antigos reaparecem após lidos, aumente este valor; valores negativos tais como -1 irão desativar este recurso",
