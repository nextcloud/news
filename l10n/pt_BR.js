OC.L10N.register(
    ...
    "Enable this to use the calculated next update time for feed updates. Disable to update feeds based solely on the update interval." : "Ative essa opção para usar o tempo calculado da próxima atualização para atualizações de feed. Desative para atualizar os feeds com base apenas no intervalo de atualização.",
    ...
    "Maximum number of articles reached in a feed update" : "Número máximo de artigos alcançados em uma atualização de feed",
    "Error Count" : "Contagem de Erros",
    "Number of errors that have occurred since the last successful feed update" : "Número de erros ocorridos desde a última atualização bem-sucedida do feed",
    "Title" : "Título",
    ...
    "Shift" : "Shift",
    "Mark current articles feed/folder as read" : "Marcar o feed/pasta de artigos atual como lido",
    "All Articles" : "Todos os Artigos",
