OC.L10N.register(
    ...
    "Request forbidden. Are you an administrator?" : "要求は禁止されています。あなたは管理者ですか?",
    ...
    "Starred" : "共有",
    "Explore" : "探索",
    "Are you sure you want to mark all read?" : "全て既読にしてよろしいですか?",
    ...
    "{num} seconds" : "{num}秒前",
    "{num} minutes ago" : "{num}分前",
    "{num} hours ago" : "{num}時前",
    "{num} days ago" : "{num}日前",
    ...
    "Subscribe to" : "次を購読:",
    "Unread Articles" : "未読の記事",
    "If given, this service" : "指定された場合、このサービス",
