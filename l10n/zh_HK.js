OC.L10N.register(
    ...
    "an article" : "一篇文章",
    "Someone" : "某人",
    "%1$s shared \"%2$s\" with you" : "%1$s 分享了 \"%2$s\" 給您",
    ...
    "Background job mode for feed updates" : "用於動態消息更新的背景作業模式",
    "Feed update method is correctly configured." : "動態消息更新方法已正確設定。",
    ...
    "Logo purge has never been run." : "標誌清除從未執行。",
    "Last logo purge ran {relativeLastLogoPurge}. Something is wrong." : "上次標誌清除執行於 {relativeLastLogoPurge}。似乎有點問題。",
    "Last logo purge job ran {relativeLastLogoPurge}." : "上次標誌清除作業執行於 {relativeLastLogoPurge}。",
    ...
    "Disable this if you use a custom updater." : "如果使用自訂更新程序，請停用此功能。",
    ...
    "Move feeds" : "移動資訊來源",
    "Move feed" : "移動摘要",
    "Moving feeds…" : "正在移動資訊來源",
    "Unable to move feed. Please try again later or check your connection." : "無法移動訂閱來源。請稍後再試或檢查你的網絡連線。",
    "Some selected feeds could not be moved. Please try again later or check your connection." : "部分已選資訊來源無法移動。請稍後再試或檢查你的網絡連線。",
    ...
    "Unable to save starred open state" : "無法儲存已加星標項目的展開狀態",
    "Mark read" : "標為已讀",
    "All articles" : "所有文章",
    ...
    "Default order" : "默認排序",
    "Downloading article text" : "正在下載文章內容",
    "Downloading of the article text has failed: {errorMessage}" : "下載文章內容失敗：{errorMessage}",
    "Show external media" : "顯示外部媒體",
    "from" : "由",
    "External media loaded from" : "外部媒體已從此處載入",
    "Previous Item" : "上一個項目",
    "Next Item" : "下一個項目",
    "Undo article text replace" : "復原文章內容替換",
    "Download web version of this article" : "下載此文章的網頁版本",
    ...
    "Keep article unread (auto-filtered)" : "保留文章為未讀（自動篩選）",
    ...
    "Refresh" : "重新整理",
    "Screenreader mode only" : "僅限螢幕閱讀器模式",
    "Jump to previous article" : "跳到上篇文章",
    "Jump to next article" : "跳到下篇文章",
    "Item navigation and control" : "項目導覽及控制",
    ...
    "Download web version of the selected article" : "下載所選文章的網頁版本",
    "Feed/Folder navigation and control" : "訂閱來源／資料夾導覽及控制",
    "Jump to previous feed" : "跳至上一個訂閱來源",
    "Jump to next feed" : "跳至下一個訂閱來源",
    "Jump to previous folder" : "跳至上一個資料夾",
    "Jump to next folder" : "跳至下一個資料夾",
    "Mark current articles feed/folder as read" : "將目前文章的 feed 或資料夾標示為已讀",
    "Resources" : "資源",
    "Unable to update keyword filters. Please try again." : "無法更新關鍵字篩選器。請再試一次。",
    "Are you sure you want to delete {count} selected feeds?" : "你確定要刪除 {count} 個已選資訊來源嗎？",
    "Some selected feeds could not be deleted. Please try again later or check your connection." : "部分已選資訊來源無法刪除。請稍後再試或檢查你的網絡連線。",
    "Last update" : "上次更新",
    "Time when the feed was last downloaded or modified" : "訂閱來源最後下載或修改的時間",
    "Next update" : "下次更新",
    ...
    "Feed update is enabled" : "已啟用訂閱更新",
    "Feed update is disabled" : "已停用訂閱更新",
    "Keep read status on update" : "更新時維持已讀狀態",
    "Mark as unread on update" : "更新時標記為未讀",
    "Use article text provided by the feed" : "使用訂閱來源提供的文章內容",
    "Scrape web version of the article text" : "擷取文章的網頁版本內容",
    "Please note that web scraping may be blocked by some providers and is generally discouraged." : "請注意，部分供應商可能會封鎖網頁擷取，且一般不建議使用。",
    "Loading feeds" : "正在載入訂閱來源",
    "Keyword filters" : "關鍵字篩選器",
    "Hide articles that match comma-separated keywords (case-insensitive) in the title, body, or URL" : "隱藏標題、內容或 URL 符合以逗號分隔關鍵字（不區分大小寫）的文章",
    "Select all feeds" : "選擇所有資訊來源",
    "Selected feeds" : "已選資訊來源",
    "Move selected" : "移動已選項目",
    "Delete selected" : "刪除所選",
    "Options" : "選項",
    "Title" : "標題",
    "Folder" : "資料夾",
    "Select feed {feed}" : "選擇資訊來源 {feed}",
    "Enable feed update" : "啟用訂閱更新",
    "Disable feed update" : "停用訂閱更新",
    "Disable marking items as unread on update" : "更新時停用將項目標記為未讀",
    "Enable marking items as unread on update" : "更新時啟用將項目標記為未讀",
    "Enable web scraping" : "啟用網頁擷取",
    "Disable web scraping" : "停用網頁擷取",
    "Not available" : "不可用",
    "Keyword Filters for {feed}" : "{feed} 的關鍵字篩選器",
    "Matching is case-insensitive. Title and body keywords match whole words, while URL keywords match URL fragments." : "比對不區分大小寫。標題及內容關鍵字會比對完整字詞，而 URL 關鍵字則比對 URL 片段。",
    "Title keywords" : "標題關鍵字",
    "e.g. android, ios" : "例如：android、ios",
    "Body keywords" : "內容關鍵字",
    "e.g. advertisement" : "例如：advertisement",
