...
"Error while loading the feed" => "Erreur lors du chargement du flux",
"Error while saving the feed in a folder" => "Erreur lors de l’enregistrement du flux dans un répertoire.",
"File " => "Fichier",
...
"Select" => "Sélectionner",
"No file selected. Select file from " => "Aucun fichier sélectionné. Sélectionnez un fichier depuis",
