OC.L10N.register(
    ...
    "Move feed to folder" : "Przenieś kanał do katalogu",
    "Move" : "Przenieś",
    ...
    "Are you sure you want to mark all read?" : "Czy na pewno chcesz oznaczyć wszystkie jako przeczytane?",
    ...
    "{num} minutes ago" : "{num} minut temu",
    "{num} hours ago" : "{num} godzin temu",
    "{num} days ago" : "{num} dni temu",
    "{num} months ago" : "{num} miesięcy temu",
    "{num} years ago" : "{num} lat temu",
    ...
    "Unread Articles" : "Nieprzeczytane artykuły",
    "If given, this service" : "Jeśli została podana, ta usługa",
