OC.L10N.register(
    ...
    "Disable this if you run a custom updater such as the Python updater included in the app." : "Wyłącz tę opcję, jeśli uruchamiasz niestandardowy aktualizator, taki jak Python zawarty w aplikacji.",
    ...
    "Maximum feed size in bytes. If the RSS/Atom page is bigger than this value, the update will be aborted." : "Maksymalna wielkość kanału w bajtach. Jeżeli strona RSS/Atom jest większa od tej wartości, aktualizacja zostanie przerwana.",
    ...
    "Interval in which the feeds will be updated." : "Przedział czasu, w którym kanały będą zaktualizowane.",
    "Saved" : "Zapisano",
    "Download" : "Pobierz",
    "Close" : "Zamknij",
    "filter" : "Filtr",
