OC.L10N.register(
    ...
    "Feed not found: Either the website does not provide a feed or blocks access. To rule out blocking, try to download the feed on your server's command line using curl: curl " : "ערוץ התוכן לא נמצא: או שהאתר אינו מספק ערוץ תוכן או שהגישה חסומה. כדי לשלול את אפשרות החסימה, כדאי לנסות להוריד את ערוץ התוכן דרך שורת הפקודה בשרת שלך בעזרת curl:‏ curl",
    ...
    "Certificate error: Initiating the SSL engine failed." : "שגיאת אישור: הפעלת מנוע ה־SSL נכשלה.",
    ...
    "Non UTF-8 charset for MySQL/MariaDB database detected!" : "זוהו תווים שאינם UTF-8 למסד הנתונים MySQL/MariaDB!",
    "Learn how to convert your database to utf8mb4 (make a backup beforehand)" : "מידע על הסבת מסד הנתונים שלך ל־utf8mb4 (כדאי להכין גיבוי לפני כן)",
