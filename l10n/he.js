OC.L10N.register(
    ...
    "Defines the maximum amount of articles that can be read per feed which won't be deleted by the cleanup job; if old articles reappear after being read, increase this value; negative values such as -1 will turn this feature off" : "מגדיר את כמות הכתבות המרבית שניתן לקרוא בהזנה שלא תימחקנה על ידי משימת הניקוי; אם כתבות ישנות תופענה מחדש לאחר קריאתן, ניתן להגדיל את הערך הזה, ערכים שליליים כגון ‎-1 יכבו את התכונה הזו.",
