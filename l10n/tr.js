OC.L10N.register(
    ...
    "The News app is an RSS/Atom feed reader for Nextcloud which can be synced with many mobile devices. A list of all clients and requirements can be found [in the README](https://github.com/nextcloud/news)\n\nBefore you update to a new version, [check the changelog](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) to avoid surprises.\n\n**Important**: To enable feed updates you will need to enable either [Nextcloud system cron](https://docs.nextcloud.org/server/latest/admin_manual/configuration_server/background_jobs_configuration.html#cron) or use [an updater](https://github.com/nextcloud/news-updater) which uses the built in update API and disable cron updates. More information can be found [in the README](https://github.com/nextcloud/news)." : "Haber uygulaması, birçok mobil cihazla senkronize edilebilen Nextcloud için bir RSS / Atom feed okuyucusudur. Tüm müşterilerin ve gereksinimlerin bir listesini [BENIOKU'da](https://github.com/nextcloud/news) bulabilirsiniz.\n\nYeni bir sürüme güncelleme yapmadan önce, sürprizleri önlemek için [değişiklik günlüğünü kontrol edin.](https://github.com/nextcloud/news/blob/master/CHANGELOG.md)\n\n**Önemli**:\nFeed güncellemelerini etkinleştirmek için [Nextcloud sistem cronunu](https://docs.nextcloud.org/server/latest/admin_manual/configuration_server/background_jobs_configuration.html#cron) etkinleştirmeniz veya yerleşik güncelleme API'sini kullanan [bir güncelleyici](https://github.com/nextcloud/news-updater) kullanmanız ve cron güncellemelerini devre dışı bırakmanız gerekir. Daha fazla bilgiyi [BENIOKU'da](https://github.com/nextcloud/news) bulabilirsiniz.",
