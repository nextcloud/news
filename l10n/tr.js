OC.L10N.register(
    ...
    "Menu" : "Menü",
    "Unpin feed from the top" : "Akışı üstten kaldır",
    "Pin feed to the top" : "Akışı üste sabitle",
    "No feed ordering" : "Akış sıralaması yok",
    "Reversed feed ordering" : "Ters akış sıralaması",
    "Normal feed ordering" : "Normal akış sıralaması",
    "Enable full text feed fetching" : "Tam metin akış alma kullanılsın",
    "Disable full text feed fetching" : "Tam metin akış alma kullanılmasın",
    "Keep updated articles as is" : "Güncellenmiş makaleler olduğu gibi korunsun",
    "Mark updated articles unread" : "Güncellenmiş makaleleri okunmamış olarak işaretle",
    "Rename feed" : "Akışı yeniden adlandır",
    "Delete feed" : "Akış sil",
