OC.L10N.register(
    ...
    "Token expired or app not enabled! Reload the page!" : "Kodun geçerlilik süresi dolmuş ya da uygulama kullanıma alınmamış! Sayfayı yenileyin!",
    ...
    "Disable this if you use a custom updater." : "Özel bir güncelleyici çalıştırıyorsanız bu seçeneği kullanımdan kaldırın.",
    ...
    "Enable this if you also want to delete unread articles." : "Okunmamış yazıların silinmesini de istiyorsanız bu seçeneği kullanıma alın.",
    ...
    "{num} seconds" : "{num} saniye",
    "{num} minutes ago" : "{num} dakika önce",
    "{num} hours ago" : "{num} saat önce",
    "{num} days ago" : "{num} gün önce",
    "{num} months ago" : "{num} ay önce",
    "{num} years ago" : "{num} yıl önce",
    ...
    "Scroll to active navigation entry" : "Gezinti girişini kullanıma almak için kaydırın",
    "Shift" : "Shift",
    ...
    "No articles available" : "Henüz bir yazı yok",
    "No unread articles available" : "Okunmamış bir yazı yok",
    "Star article" : "Yazıya yıldız koy",
    "Unstar article" : "Yazının yıldızını kaldır",
    ...
    "Toggle expand article in compact view" : "Sıkışık görünümde yazıyı genişlet/daralt",
    "Mark current article's feed/folder read" : "Geçerli yazı akışını/klasörünü okunmuş olarak işaretle",
    "Folder" : "Klasör",
    "Go back" : "Geri dön",
    "New Folder" : "Yeni klasör",
    "Create" : "Ekle",
    ...
    "Expand articles on key navigation" : "Tuşla gezinme sırasında yazılar genişletilsin",
