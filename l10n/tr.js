OC.L10N.register(
    ...
    "Certificate error: Problem with reading the SSL CA cert (path? access rights?)" : "Sertifika sorunu: SSL CA sertifikası okunurken sorun çıktı (yol ya da erişim hakkı sorunu?)",
