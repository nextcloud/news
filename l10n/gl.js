OC.L10N.register(
    ...
    {
    "News" : "Novas",
    "an article" : "un artigo",
    "Someone" : "Alguén",
    "%1$s shared \"%2$s\" with you" : "%1$s compartiu «%2$s» con Vde.",
    "{user} shared \"{article}\" with you" : "{user} compartiu «{article}» con Vde.",
    ...
    "Untitled article" : "Artigo sen título",
    ...
    "Show external media" : "Amosar os multimedia externos",
    "from" : "desde",
    "External media loaded from" : "Multimedia externos cargados desde",
    ...
    "Media" : "Multimedia",
    "Show embedded thumbnails" : "Amosar as miniaturas incrustadas",
