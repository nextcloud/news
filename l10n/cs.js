OC.L10N.register(
    ...
    "Minimum amount of seconds after deleted feeds and folders are removed from the database; values below 60 seconds are ignored." : "Jak dlouho přinejmenším (v sekundách) po smazání kanálů a složek počkat s jejich odebráním i z databáze (hodnoty kratší než 60 sekund jsou ignorovány).",
    ...
    "Delete unread items automatically" : "Automaticky mazat i nepřečtené položky",
    "Enable this if you also want to delete unread items." : "Pokud chcete mazat také nepřečtené položky, zapněte toto.",
