...
"Are you sure you want to delete this folder and all its feeds?" => "Esta seguro de querer borrar la carpeta y las fuentes contenidas en el.",
"Warning" => "Alerta.",
...
"Are you sure you want to delete this feed?" => "Esta seguro de querer borrar esta fuente?",
"Error while loading the feed" => "Error mientras se cargaba la fuente ",
"Error while saving the feed in a folder" => "Error mientras se salvaba la fuente en una carpeta",
"File " => "Fichero",
