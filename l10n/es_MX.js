OC.L10N.register(
    ...
    "The News app is an RSS/Atom feed reader for Nextcloud which can be synced with many mobile devices. A list of all clients and requirements can be found [in the README](https://github.com/nextcloud/news)\n\nBefore you update to a new version, [check the changelog](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) to avoid surprises.\n\n**Important**: To enable feed updates you will need to enable either [Nextcloud system cron](https://docs.nextcloud.com/server/10/admin_manual/configuration_server/background_jobs_configuration.html#cron) or use [an updater](https://github.com/nextcloud/news-updater) which uses the built in update API and disable cron updates. More information can be found [in the README](https://github.com/nextcloud/news)." : "La aplicación de Noticias es un lector de fuentes RSS/Atom para Nextcloud que puede ser sincronizado con muchos dispositivos móviles. Una lista de todos los clientes y requerimientos se puede encontrar [en el README](https://github.com/nextcloud/news)\n\nAntes de que actualices a una nueva versión, [verifca el la bitácora de cambios](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) para evitar sorpresas.\n\n**Importante**. Para habilitar actualizaciones de fuentes tendrás que habilitar ya sea [el cron del sistema Nextcloud](https://docs.nextcloud.com/server/10/admin_manual/configuration_server/background_jobs_configuration.html#cron) o usar [un actualizador](https://github.com/nextcloud/news-updater) que usa el API de actualización integrada y deshabilita las actualizaciones de cron. Hay más información disponible [en el README](https://github.com/nextcloud/news).",
