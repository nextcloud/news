...
"Request failed, network connection " => "요청을 실패하였습니다. 네트워크 연결을 사용할 수 없습니다.",
...
"Token expired or app not enabled! " => "토큰이 만료되었거나 앱이 활성화되어 있지 않습니다. 페이지를 새로 고침 해 보십시오.",
...
"Token expired or app not enabled! Try to reload the page!" => "토큰이 만료되었거나 앱이 활성화되어 있지 않습니다. 페이지를 새로 고침 해 보십시오.",
...
"by" => "작성:",
"from" => "원본 사이트:",
"Browser can not play media type" => "브라우저에서 미디어 형식을 재생할 수 없음",
"Download" => "다운로드",
