OC.L10N.register(
    "news",
    {
    "Request failed, network connection unavailable!" : "Förfrågan misslyckades, nätverksanslutning otillgänglig!",
    "Request unauthorized. Are you logged in?" : "Ogiltig begäran. Är du inloggad?",
    "Request forbidden. Are you an administrator?" : "Förfrågan förbjuden. Är du administratör?",
    ...
    "{num} minutes ago" : "{num} minuter sedan",
    "{num} hours ago" : "{num} timmar sedan",
    ...
    "Error while searching for users" : "Kunde inte söka bland användare",
    "Share on social media" : "Dela via sociala medier",
    "I wanted you to see this article" : "Jag vill rekommendera dig den här artikeln",
    "Check out this article" : "Spana in den här artikeln",
