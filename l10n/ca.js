OC.L10N.register(
    ...
    "How many redirects the feed fetcher should follow" : "Quants redirigits hauria de suportar el descarregador de fonts?",
    ...
    "Maximum number of seconds to wait for an RSS or Atom feed to load; if it takes longer the update will be aborted" : "Nombre màxim de segons per esperar que es carregui una font de RSS o Atom; si triga més temps, l'actualització serà cancel·lada.",
    "Explore Service URL" : "Explora l'URL del Servei",
    "If given, this service's URL will be queried for displaying the feeds in the explore feed section. To fall back to the built in explore service, leave this input empty" : "En cas d'haver-se emplenat, la URL d'aquest servei serà consultada per mostrar les fonts de la secció explorar fonts. Per tornar al servei d'exploració integrat, deixeu aquest camp buit",
    ...
    "Language" : "Idioma",
    "Subscribe" : "Subscriu",
    "Got more awesome feeds? Share them with us!" : "Teniu fonts més increïbles? Compartiu-los amb nosaltres!",
    ...
    "Remove keep article unread" : "No mantinguis l'article com a no llegit ",
    "by" : "per",
    "from" : "des de",
    ...
    "Refresh" : "Refresca",
    "Load next feed" : "Carrega la font següent",
    ...
    "Focus search field" : "Camp de cerca de focus",
    "Mark current article's feed/folder read" : "Marca com a llegida la font/carpeta de l'article actual",
    "Ajax or webcron mode detected! Your feeds will not be updated!" : "S'ha detectat el mode Ajax o webcron. Les vostres fonts no s'actualitzaran!",
    ...
    "Learn how to convert your database to utf8mb4 (make a backup beforehand)" : "Apreneu a convertir la vostra base de dades a utf8mb4 (feu una còpia de seguretat prèviament)",
    ...
    "Deleted feed" : "S'ha suprimit la font",
    "Undo delete feed" : "Desfés la supressió de la font",
    ...
    "Error when importing: OPML is does neither contain feeds nor folders" : "S'ha produït un error mentre s'importava: OPML no conté ni fonts ni carpetes",
