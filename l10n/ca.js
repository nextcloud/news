OC.L10N.register(
    ...
    "Disable automatic refresh" : "Desactiva l'actualització automàtica",
    ...
    "{num} seconds" : "{num} segons",
    "{num} minutes ago" : "Fa {num} minuts",
    "{num} hours ago" : "Fa {num} hores",
    ...
    "Next update" : "Propera actualització",
    "Time when the next feed update will be done" : "Hora en què es farà la propera actualització del canal",
    "Only if activated in the admin settings, otherwise the regular update interval is used" : "Només si està activat a la configuració de l'administració, en cas contrari s'utilitza l'interval d'actualització regular",
    ...
    "Refresh" : "Refresca",
    "Load next feed" : "Carrega el canal següent",
    "Load previous feed" : "Carrega el canal anterior",
    ...
    "Unread Articles" : "Articles sense llegir",
    "If given, this service" : "Si es dóna, aquest servei",
    ...
    "Toggle expand article in compact view" : "Commuta expandir l'article a una vista compacta",
    "Mark current article's feed/folder read" : "Marca com a llegida la canal/carpeta de l'article actual",
    "Folder" : "Carpeta",
    "Go back" : "Torna enrere",
    "New Folder" : "Nova carpeta",
    "Create" : "Crea",
    "Update failed more than 50 times" : "L'actualització ha fallat més de 50 vegades",
    "Deleted feed" : "S'ha suprimit el canal",
    "Undo delete feed" : "Desfés la supressió del canal",
    "Menu" : "Menú",
    "Open feed URL" : "Obre l'URL del canal",
    "Dismiss" : "Descarta",
    "Collapse" : "Replega",
    ...
    "Import" : "Importa",
    "Export" : "Exporta",
    "Error when importing: File does not contain valid OPML" : "S'ha produït un error mentre s'importava: el fitxer no conté OPML vàlid",
    "Error when importing: OPML is does neither contain feeds nor folders" : "S'ha produït un error mentre s'importava: OPML no conté ni canals ni carpetes",
