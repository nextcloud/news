...
"Download" => "ダウンロード",
"Close" => "閉じる",
"Ajax cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." => "Ajax cronモードが検出されました！フィードは正しく更新されません。オペレーティングシステムのcronか、カスタムアップデーターの使用をお勧めします。",
