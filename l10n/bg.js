OC.L10N.register(
    ...
    "Certificate error: Initiating the SSL Engine failed." : "Грешка в сертификата: Инициализацията на SSL софтуера се провали.",
    ...
    "Rename" : "Преименуване",
    "Menu" : "Меню",
    "Unpin feed from the top" : "Премахване на емисията от началото",
    "Pin feed to the top" : "Поставяне на емисията в началото",
    "No feed ordering" : "Без подреждане",
    "Reversed feed ordering" : "Обратен ред",
    "Normal feed ordering" : "Нормален ред",
    "Enable full text feed fetching" : "Разрешаване на пълнотекстово извличане на емисията",
    "Disable full text feed fetching" : "Забраняване на пълнотекстово извличане на емисията",
    "Mark updated articles unread" : "Маркиране на обновените статии като нечетени",
