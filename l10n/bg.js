OC.L10N.register(
    ...
    "Unstar article" : "Означи със звезда",
    ...
    "Mark current article's feed/folder read" : "Маркирай статиите от текущият поток/папка като прочетени",
    ...
    "Rename" : "Преименувай",
    "Menu" : "Меню",
    "Mark read" : "Маркирай като прочетена",
