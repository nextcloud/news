...
"Use ownCloud cron for updates" => "använd owncloud-cron för uppdateringar",
...
"by" => "av",
"from" => "från",
"Browser can not play media type" => "Webbläsaren kan inte spela mediatyp",
"Download" => "Ladda ner",
...
"Expand articles in compact view when navigating with keyboard shortcuts" => "Expandera artiklar i kompakt vy vid navigering med tangentbordsgenvägar",
