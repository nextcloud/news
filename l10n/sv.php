...
"Error while saving the feed in a folder" => "Ett fel uppstod när flödet skulle sparas i en mapp",
"File " => "Fil",
...
"Import kind not specified" => "Importeringstyp är inte specificerad",
" out of " => "utav",
...
"Select" => "Välj",
"No file selected. Select file from " => "Ingen fil vald. Välj från",
