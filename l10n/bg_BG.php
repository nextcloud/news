...
"Show unread articles" => "Покажи непрочетени статии",
"Order by oldest first" => "Подреди по намаляваща възраст",
"Disable mark read during scrolling" => "Премахни отбелижи като прочетено по време на скролиране",
