...
"Certificate error: The remote server's SSL certificate or SSH md5 fingerprint was deemed not OK." => "Sertifikatfeil: Den eksterne serverens SSL-sertifikat eller SSH md5 fingerprint ble vurdert som ikke OK.",
...
"HTTP Basic Auth credentials must be stored unencrypted! Everyone with access to the server or database will be able to access them!" => "Detaljer for HTTP Basic Auth må lagres ukryptert! Alle med tilgang til serveren eller databasen vil være i stand til å aksessere dem!",
"Username" => "Brukernavn",
"Password" => "Passord",
"New Folder" => "Ny mappe",
"Create" => "Opprett",
