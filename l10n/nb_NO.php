...
"Disable this if you run a custom updater such as the Python updater included in the app" => "Deaktiver dette hvis du kjører en tilpasset updater, som f.eks. Python-opdatereren som er inkludert i appen",
