...
"Internal server error! Please check your " => "Intern serverfeil! Vennligst sjekk",
"Request failed, ownCloud is in currently " => "Forespørsel feilet, ownCloud er for øyeblikket",
...
"Download" => "Last ned",
"Close" => "Lukk",
"Ajax cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." => "Ajax cron-modus oppdaget! Nyhetskildene dine vil ikke bli oppdatert på rett måte. Det anbefales å enten bruke operativsystemets cron eller en tilpasset oppdaterer.",
