OC.L10N.register(
    ...
    "Feed not found: Either the website does not provide a feed or blocks access. To rule out blocking, try to download the feed on your server's command line using curl: curl " : "Feed 未找到：可能是网站未提供 feed 或阻止了访问。请解除阻止，尝试在您服务器的命令行上使用 curl 下载 feed",
    ...
    "Certificate error: A problem occurred somewhere in the SSL/TLS handshake. Could be certificates (file formats, paths, permissions), passwords, and others." : "证书错误：SSL/TLS 握手的时候在某地方出现问题。请检查证书（文件格式，路径，权限）密码及其它。",
