...
"Request failed, network connection " => "Запрос не удался, нет соединения",
...
"Token expired or app not enabled! " => "Истёк срок действия ключа или приложение не включено!",
...
"Token expired or app not enabled! Try to reload the page!" => "Истёк срок действия ключа или приложение не включено! Попробуйте перезагрузить страницу!",
