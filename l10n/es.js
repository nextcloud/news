OC.L10N.register(
    ...
    "Certificate error: Initiating the SSL Engine failed." : "Error de certificado: ha fallado la iniciación del recurso SSL. ",
    ...
    "For more information check the Wiki" : "Para más información consultar la Wiki",
    "Saved" : "Guardado",
    "Download" : "Descargar",
    "Close" : "Cerrar",
    "Ajax or Web cron mode detected! Your feeds will not be updated!" : "¡Detectado modo Ajax o Web cron! ¡Tus feeds no se actualizarán!",
    ...
    "Mark updated unread" : "Marcar los actualizados como no leídos",
