OC.L10N.register(
    ...
    "The News app is an RSS/Atom feed reader for Nextcloud which can be synced with many mobile devices. A list of all clients and requirements can be found [in the README](https://github.com/nextcloud/news)\n\nBefore you update to a new version, [check the changelog](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) to avoid surprises.\n\n**Important**: To enable feed updates you will need to enable either [Nextcloud system cron](https://docs.nextcloud.com/server/10/admin_manual/configuration_server/background_jobs_configuration.html#cron) or use [an updater](https://github.com/nextcloud/news-updater) which uses the built in update API and disable cron updates. More information can be found [in the README](https://github.com/nextcloud/news)." : "La app de Noticias es un lector de fuentes RSS/Atom para Nextcloud que puede sincronizarse con muchos dispositivos móviles. Una lista de todos los clientes y requisitos puede encontrarse [en el archivo README](https:///github.com/nextcloud/news)\n\nAntes de actualizar a una nueva versión, [comprueba el registro de cambios](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) para evitar sorpresas.\n\n**Importante**: para activar las actualizaciones de las fuentes, tendrás que activar [el cron del sistema de Nextcloud](https://docs.nextcloud.com/server/13/admin_manual/configuration_server/background_jobs_configuration.html#cron) o usar [un actualizador](https://github.com/nextcloud/news-updater) que usa la API de actualización incorporada y desactiva las actualizaciones del cron. Más información [en el archivo README](https://github.com/nextcloud/news).",
