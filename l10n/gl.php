...
"Download" => "Descargar",
"Close" => "Pechar",
"Ajax or webcron cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." => "Detectouse o modo cron de Ajax ou de webcron! As súas fontes non se actualizarán correctamente. É recomendábel ben utilizar o cron do sistema operativo ou ben un actualizador personalizado.",
...
"Reversed feed ordering" => "Ordenado inverso da fonte",
"Normal feed ordering" => "Ordenado normal da fonte",
