OC.L10N.register(
    ...
    "Minimum amount of seconds after deleted feeds and folders are removed from the database; values below 60 seconds are ignored" : "Мінімальна кількість секунд, після чого стрічки й теки, які було стерто, буде вилучено з бази даних; значення менше 60 секунд буде проігноровано",
