OC.L10N.register(
    ...
    "Token expired or app not enabled! Reload the page!" : "Термін дії токена закінчився або застосунок не увімкнено! Оновіть сторінку!",
    ...
    "{num} minutes ago" : "{num} хвилин тому",
    "{num} hours ago" : "{num} годин тому",
