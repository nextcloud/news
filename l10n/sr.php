...
"Request failed, ownCloud is in currently " => "Захтев није успео, ownCloud је у тренутном",
...
"Use ownCloud cron for updates" => "Користите крон сопственогОблака за ажурирања",
...
"Download" => "Преузми",
"Close" => "Затвори",
"Ajax cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." => "Откривен је режим Ајакс крона! Ваше емисије неће бити ажуриране коректно. Препоручено је да користите системски крон или прилагођени програм за ажурирање.",
