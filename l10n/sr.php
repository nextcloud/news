...
"Download" => "Преузми",
"Close" => "Затвори",
"Ajax or webcron cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." => "Откривен је режим Ајакс или веб-крона! Ваши доводи неће бити ажурирани коректно. Препоручено је да користите системски крон или прилагођени програм за ажурирање.",
