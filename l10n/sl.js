OC.L10N.register(
    ...
    "Maximum number of seconds to wait for an RSS or Atom feed to load; if it takes longer the update will be aborted" : "Čas, namenjen nalaganju virov RSS in Atom. Po tem času je nalaganje virov prekinjeno.",
