OC.L10N.register(
    ...
    "Request failed, network connection unavailable!" : "Zahteva je spodletela, mrežna povezava ni na voljo!",
    "Request unauthorized. Are you logged in?" : "Zahteva ni dovoljena. Ali ste prijavljeni?",
    "Request forbidden. Are you an admin?" : "Zahteva zavrnjena. Ali ste administrator?",
    "Token expired or app not enabled! Reload the page!" : "Ključ je potekel ali aplikacija ni omogočena! Osvežite stran!",
    "Internal server error! Please check your " : "Interna napaka strežnika! Preverite vaš",
    "Request failed, ownCloud is in currently " : "Zahteva ni uspela, ownCloud je trenutno",
    ...
    "Download video" : "Prenesi video",
    "Download audio" : "Prenesi zvok",
    ...
    "Scroll to active navigation entry" : "Premakni se na aktivni navigacijski element",
    "Focus search field" : "Označi iskalno polje",
    "Mark current article's feed/folder read" : "Označi trenutno novico/mapo kot prebrano",
    ...
    "Reverse ordering (oldest on top)" : "Obratno razvrščanje (najstarejši na vrh)",
