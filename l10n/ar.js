OC.L10N.register(
    ...
    "Request forbidden. Are you an administrator?" : "طلب مرفوض. هل أنت مدير؟",
    ...
    "{num} seconds" : "{num} ثوانٍ",
    "{num} minutes ago" : "منذ {num} دقائق",
    "{num} hours ago" : "منذ {num} ساعات",
    "{num} days ago" : "منذ {num} أيام",
    "{num} months ago" : "منذ {num} أشهر",
    "{num} years ago" : "منذ {num} سنوات",
    ...
    "Mark current article's feed/folder read" : "تمييز الإلقام أو مجلد المقالات الحالي كمقروءٍ",
    "Folder" : "مجلد",
    "Go back" : "عودة",
    "New Folder" : "مجلد جديد",
    "Create" : "أنشيء",
    "Update failed more than 50 times" : "فشل التحديث لأكثر من 50 مرة",
    "Deleted feed" : "إلقام محذوف",
    "Undo delete feed" : "التراجع عن حذف الإلقام",
    "Menu" : "القائمة ",
    "Open feed URL" : "فتح عنوان URL الخاص بتغذية الأخبار",
    "Dismiss" : "تراجع",
    "Collapse" : "طوي",
    ...
    "Error when importing: OPML is does neither contain feeds nor folders" : "خطأ عند الاستيراد: لا يحتوي ملف OPML على لُقَمٍ و لا مجلدات",
