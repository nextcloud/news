OC.L10N.register(
    ...
    "Minimum amount of seconds after deleted feeds and folders are removed from the database; values below 60 seconds are ignored" : "Minimální časový interval v sekundách po kterém jsou smazány z databáze odstraněné kanály novinek a adresáře; hodnoty kratší než 60 sekund jsou ignorovány",
    "Maximum read count per feed" : "Maximální počet novinek na kanál",
    ...
    "Star article and jump to next one" : "Ocenit článek hvězdičkou a přejít na další",
    "Toggle keep current article unread" : "Přepnout ponechání článku jako nepřečtený",
