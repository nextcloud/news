...
"Request failed, network connection " => "Το αίτημα απέτυχε, σύνδεση στο δίκτυο",
...
"Token expired or app not enabled! " => "Το σημείο έληξε ή η εφαρμογή δεν είναι ενεργοποιημένη!",
...
"Token expired or app not enabled! Try to reload the page!" => "Το σημείο έληξε ή η εφαρμογή δεν είναι ενεργοποιημένη! Προσπαθήστε να επαναφορτώσετε τη σελίδα!",
