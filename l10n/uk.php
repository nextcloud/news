...
"Error: address must not be empty!" => "Помилка: Адреса не повинна бути порожньою !",
"Error: address exists already!" => "Помилка: Адреса вже існує !",
"Error: folder name must not be empty!" => "Помилка: ім'я теки не повинно бути порожнім !",
