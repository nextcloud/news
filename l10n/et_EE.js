OC.L10N.register(
    ...
    "Request forbidden. Are you an administrator?" : "Päring on keelatud. Kas sa ikka oled peakasutaja õigustes?",
    "Token expired or app not enabled! Reload the page!" : "Tunnusluba on aegunud või rakendus pole kasutusel. Palun laadi leht uuesti!",
    "Internal server error! Please check your data/nextcloud.log file for additional information!" : "Serveri sisemine viga! Lisateavet leiad data/nextcloud.log failist!",
    "Request failed, Nextcloud is in currently in maintenance mode!" : "Päring ei õnnestunud, Nextcloud on hetkel hooldusrežiimis!",
    ...
    "Last job execution ran {relativeTime}. Something seems wrong." : "Viimane käivitus kestis {relativeTime}. See pole päris õige.",
    ...
    "Article feed information" : "Artikli uudisvoo teave",
    ...
    "(screenreader mode)" : "(ekraanilugeja vaade)",
    ...
    "Scroll to active navigation entry" : "Keri aktiivse kirjeni/artiklini",
    "Shift" : "Nihuta",
    ...
    "Subscribe to" : "Telli",
    "Unread Articles" : "Lugemata artiklid",
    "If given, this service" : "Kui on olemas, siis see teenus",
    ...
    "I wanted you to see this article" : "Ma soovisin, et sa näeksid seda artiklit",
    "Check out this article" : "Tutvu selle artikliga",
    ...
    "Menu" : "Menüü",
    "Unread updated" : "Märgi uuendatud artiklid mitteloetuks",
    "Ignore updated" : "Eira uuendatuid",
    "Open feed URL" : "Ava uudisvoo võrguaadress",
    "Dismiss" : "Jäta vahele",
    "Collapse" : "Sulge",
    ...
    "Expand articles on key navigation" : "Liikumisel klahvistiku abil näita artikli täisvaadet",
    "Subscriptions (OPML)" : "Tellimused (OPML)",
    "Import" : "Impordi",
    "Export" : "Ekspordi",
    "Error when importing: File does not contain valid OPML" : "Viga importimisel: fail ei sisalda korrektset OPML-vormingut",
    "Error when importing: OPML is does neither contain feeds nor folders" : "Viga importimisel: OPML-failis pole uudisvooge ega kaustu",
