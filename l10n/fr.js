OC.L10N.register(
    ...
    "Explore Service URL" : "Explorer l'URL du service",
    "If given, this service's URL will be queried for displaying the feeds in the explore feed section. To fall back to the built in explore service, leave this input empty" : "Si indiquée, cette URL de service sera interrogée pour afficher les flux dans la section \"explorer le flux\". Pour revenir au service d'exploration par défaut, laisser ce champ vide.",
    "Saved" : "Sauvegardé",
    "Ajax cron mode detected! Your feeds will not be updated correctly. It is recommended to either use the operating system cron or a custom updater." : "Mode cron Ajax détecté ! Vos flux ne seront pas correctement mis à jour. Il est recommandé de soit utiliser le cron du système d'exploitation ou un outil de mise à jour personnalisé.",
    "How to set up the operating system cron" : "Comment configurer le cron du système d'exploitation",
    "How to set up a custom updater (faster and no possible deadlock) " : "Comment configurer un outil de mise à jour personnalisé (plus rapide et sans blocage possible)",
    "Subscribe" : "S'abonner",
    "Refresh" : "Rafraîchir",
