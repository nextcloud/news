OC.L10N.register(
    ...
    "The News app is an RSS/Atom feed reader for Nextcloud which can be synced with many mobile devices. A list of all clients and requirements can be found [in the README](https://github.com/nextcloud/news)\n\nBefore you update to a new version, [check the changelog](https://github.com/nextcloud/news/blob/master/CHANGELOG.md) to avoid surprises.\n\n**Important**: To enable feed updates you will need to enable either [Nextcloud system cron](https://docs.nextcloud.com/server/10/admin_manual/configuration_server/background_jobs_configuration.html#cron) or use [an updater](https://github.com/nextcloud/news-updater) which uses the built in update API and disable cron updates. More information can be found [in the README](https://github.com/nextcloud/news)." : "L'application \"Nouvelles\" est un lecteur de flux RSS / Atom pour Nextcloud qui peut être synchronisé avec de nombreux appareils mobiles. Une liste de tous les clients et les exigences peuvent être trouvées [dans le fichier README] (https://github.com/nextcloud/news)\n\nAvant de passer à une nouvelle version, [vérifiez le journal des modifications] (https://github.com/nextcloud/news/blob/master/CHANGELOG.md) pour éviter les surprises.\n\n** Important **: Pour activer les mises à jour de flux, vous devez activer [Nextcloud system cron] (https://docs.nextcloud.com/server/10/admin_manual/configuration_server/background_jobs_configuration.html#cron) ou utiliser [un updater] (https://github.com/nextcloud/news-updater) qui utilise l'API de mise à jour intégrée et désactive les mises à jour cron. Plus d'informations peuvent être trouvées [dans le fichier README] (https://github.com/nextcloud/news).",
