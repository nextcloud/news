OC.L10N.register(
    ...
    "Feed not found: Either the website does not provide a feed or blocks access. To rule out blocking, try to download the feed on your server's command line using curl: curl " : "Лента не найдена: либо сайт не предоставляет ленту, либо доступ заблокирован. Для определения блокировки, попробуйте загрузить ленту с командной строки в вашем сервере, используя curl: curl ",
