OC.L10N.register(
    ...
    "Move feed to folder" : "Переместить ленту в папку",
    "Move" : "Переместить",
    ...
    "{num} minutes ago" : "{num}минут назад",
    "{num} hours ago" : "{num}часов назад",
    "{num} days ago" : "{num}дней назад",
    "{num} months ago" : "{num}месяцев назад",
    "{num} years ago" : "{num}лет назад",
