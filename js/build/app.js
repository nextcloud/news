(function(window, document, angular, $, OC, csrfToken, undefined) {
  ...
  (function(window, document, $) {
      ...
      for (var $__3 = items[$traceurRuntime.toProperty(Symbol.iterator)](),
        ...
        var item = $__4.value;
        {
          ...
          if (item.position().top >= 0) {
            previous$__37 = item.prev();
            if (previous$__37.length > 0) {
              scrollToItem(scrollArea, previous$__37);
            }
            return;
          }
        }
    ...
    var getActiveItem = (function(scrollArea) {
      ...
      for (var $__3 = items[$traceurRuntime.toProperty(Symbol.iterator)](),
        ...
        {
          item$__38 = $(item$__38);
          if ((item$__38.height() + item$__38.position().top) > 30) {
            return item$__38;
          }
        }
      }
    ...
    $(document).keyup((function(event) {
      ...
      if (noInputFocused($(':focus')) && noModifierKey(event)) {
        keyCode$__39 = event.keyCode;
        scrollArea$__40 = $('#app-content');
        if ([74, 78, 33].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          scrollToNextItem(scrollArea$__40);
        } else if ([75, 80, 37].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          scrollToPreviousItem(scrollArea$__40);
        } else if ([85].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          toggleUnread(scrollArea$__40);
        } else if ([69].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          expandItem(scrollArea$__40);
        } else if ([73, 83, 76].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          toggleStar(scrollArea$__40);
        } else if ([72].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          toggleStar(scrollArea$__40);
          scrollToNextItem(scrollArea$__40);
        } else if ([79].indexOf(keyCode$__39) >= 0) {
          event.preventDefault();
          openLink(scrollArea$__40);
        }
      }
    }));
  }(window, document, $));
  ...
  window.items = function(obj) {
    ...
    return ($__2 = {}, Object.defineProperty($__2, Symbol.iterator, {
      value: function() {
        return ($traceurRuntime.initGeneratorFunction(function $__52() {
          var $__53,
              $__54,
              $__55,
              $__56,
            ...
            while (true)
              switch ($ctx.state) {
                ...
                case 15:
                  ...
                  break;
                case 13:
                  $ctx.state = ($__56 < $__53.length) ? 9 : -2;
                  break;
                case 4:
                  $__56++;
                  $ctx.state = 13;
                  break;
                case 9:
                  x$__41 = $__53[$traceurRuntime.toProperty($__56)];
                  $ctx.state = 10;
                  break;
                case 10:
                  $ctx.state = (!($traceurRuntime.toProperty(x$__41) in $__54)) ? 4 : 7;
                  break;
                case 7:
                  $ctx.state = (call(hasOwn, obj, x$__41)) ? 1 : 4;
                  break;
                case 1:
                  $ctx.state = 2;
                  return [x$__41, obj[$traceurRuntime.toProperty(x$__41)]];
                case 2:
                  $ctx.maybeThrow();
                  $ctx.state = 4;
                  break;
            ...
            while (true)
              switch ($ctx.state) {
                case 0:
                  ...
                  break;
                case 7:
                  $ctx.state = (counter$__42 < list.length) ? 1 : -2;
                  break;
                case 4:
                  counter$__42 += 1;
                  $ctx.state = 7;
                ...
                case 1:
                  $ctx.state = 2;
                  return [counter$__42, list[$traceurRuntime.toProperty(counter$__42)]];
                case 2:
                  $ctx.maybeThrow();
                  $ctx.state = 4;
                  break;
        ...
        return ($traceurRuntime.initGeneratorFunction(function $__52() {
          ...
          return $traceurRuntime.createGeneratorInstance(function($ctx) {
            while (true)
              switch ($ctx.state) {
                case 0:
                  counter$__43 = list.length;
                  $ctx.state = 7;
                  break;
                case 7:
                  $ctx.state = (counter$__43 >= 0) ? 1 : -2;
                  break;
                case 4:
                  counter$__43 -= 1;
                  $ctx.state = 7;
                ...
                case 1:
                  $ctx.state = 2;
                  return list[$traceurRuntime.toProperty(counter$__43)];
                case 2:
                  $ctx.maybeThrow();
                  $ctx.state = 4;
                  break;
  ...
  app.directive('newsScroll', (["$timeout", function($timeout) {
    ...
    var autoPage = (function(enabled, limit, elem, scope) {
      ...
      if (enabled) {
        counter$__44 = 0;
        articles$__45 = elem.find('.item');
        for (var i$__46 = articles$__45.length - 1; i$__46 >= 0; i$__46 -= 1) {
          item$__47 = $(articles$__45[$traceurRuntime.toProperty(i$__46)]);
          if (counter$__44 >= limit) {
            break;
          }
          if (item$__47.position().top < 0) {
    ...
    var markRead = (function(enabled, elem, scope) {
      ...
      if (enabled) {
        ids$__48 = [];
        articles$__49 = elem.find('.item:not(.read)');
        for (var i$__50 = 0; i$__50 < articles$__49.length; i$__50 += 1) {
          item$__51 = $(articles$__49[$traceurRuntime.toProperty(i$__50)]);
          if (item$__51.position().top <= -50) {
            ids$__48.push(parseInt(item$__51.data('id'), 10));
          } else {
            break;
          }
        }
        scope.itemIds = ids$__48;
