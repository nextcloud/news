    ...
    'Request', 'FeedLoading', 'AutoPageLoading', 'NewLoading', 'Config', 'ActiveFeed', '$rootScope', '$q', function(Request, FeedLoading, AutoPageLoading, NewLoading, Config, ActiveFeed, $rootScope, $q) {
      ...
      Persistence = (function() {
        ...
        Persistence.prototype.init = function() {
          ...
          this.getSettings();
          this.getActiveFeed((function(_this) {
            return function() {
        ...
        Persistence.prototype.getItems = function(type, id, offset, onSuccess) {
          ...
          (function(_this) {
            return (function(lastChange, offset, loading, onSuccess) {
          ...
          })(this)(lastChange, offset, loading, onSuccess);
        ...
        Persistence.prototype.getAllFeeds = function(onSuccess, showLoading) {
          ...
          if (showLoading) {
            ...
            successCallbackWrapper = (function(_this) {
              return function(data) {
                onSuccess();
                return _this._feedLoading.decrease();
              };
            })(this);
            failureCallbackWrapper = (function(_this) {
              return function(data) {
                return _this._feedLoading.decrease();
              };
            })(this);
...
(function() {
  ...
  angular.module('News').factory('_LessThanQuery', [
    '_Query', function(_Query) {
      var LessThanQuery;
...
(function() {
  ...
  angular.module('News').factory('_LessThanEqualQuery', [
    '_Query', function(_Query) {
...
(function() {
  ...
  angular.module('News').factory('_MaximumQuery', [
    '_Query', function(_Query) {
      var MaximumQuery;
...
(function() {
  ...
  angular.module('News').factory('_MinimumQuery', [
    '_Query', function(_Query) {
      var MinimumQuery;
...
(function() {
  angular.module('News').factory('_Query', [
...
(function() {
  ...
  angular.module('News').factory('_UnequalQuery', [
    '_Query', function(_Query) {
      var UnequalQuery;
...
(function() {
  angular.module('News').factory('Utils', function() {
    return OC;
  });
