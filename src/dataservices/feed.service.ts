...
export class FeedService {
	 ...
	 *
	 * @return Feed info stored in array property data.feeds
	 */
	 ...
	 * @return Feed info stored in data.feeds[0] property
	 */
	 ...
	 * @return Updated feed info (unreadCount = 0) stored in data.feeds[0] property
	 */
